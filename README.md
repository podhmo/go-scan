...
For tools built on `go-scan` that use the `symgo` symbolic execution engine, a dedicated testing library called `symgotest` is provided to simplify writing tests.
