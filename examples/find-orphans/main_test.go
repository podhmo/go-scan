...
func TestFindOrphans_WithStdlibTypeResolution(t *testing.T) {
	...
	// resolve a type from the standard library. The PackageLoadHook should
...
// return type, *json.Encoder. Without the hook, this would trigger a scan
// of the encoding/json package in the Go SDK.
