...
func Install(interp *minigo.Interpreter) {
	interp.Register("net/http", map[string]any{
		...
		"CloseNotifier":                       (*http.CloseNotifier)(nil),
		"ConnState":                           (*http.ConnState)(nil),
		"Cookie":                              (*http.Cookie)(nil),
		"CookieJar":                           (*http.CookieJar)(nil),
		"Dir":                                 (*http.Dir)(nil),
		"File":                                (*http.File)(nil),
		"FileSystem":                          (*http.FileSystem)(nil),
		"Flusher":                             (*http.Flusher)(nil),
		"HTTP2Config":                         (*http.HTTP2Config)(nil),
		"Handler":                             (*http.Handler)(nil),
		"HandlerFunc":                         (*http.HandlerFunc)(nil),
		"Header":                              (*http.Header)(nil),
		"Hijacker":                            (*http.Hijacker)(nil),
		"MaxBytesError":                       (*http.MaxBytesError)(nil),
		"ProtocolError":                       (*http.ProtocolError)(nil),
		"Protocols":                           (*http.Protocols)(nil),
		"PushOptions":                         (*http.PushOptions)(nil),
		"Pusher":                              (*http.Pusher)(nil),
		"Request":                             (*http.Request)(nil),
		"Response":                            (*http.Response)(nil),
		"ResponseController":                  (*http.ResponseController)(nil),
		"ResponseWriter":                      (*http.ResponseWriter)(nil),
		"RoundTripper":                        (*http.RoundTripper)(nil),
		"SameSite":                            (*http.SameSite)(nil),
		"ServeMux":                            (*http.ServeMux)(nil),
