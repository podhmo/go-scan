...
- [ ] **Dynamic Interface Resolution**: Complete the refactoring of the `symgo` evaluator to support dynamic interface resolution. See `docs/cont-symgo-iface.md` for detailed status and next steps.
