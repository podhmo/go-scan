...
func TestStdlibSource(t *testing.T) {
	// t.Skip("Skipping tests for source-loaded stdlib packages due to unresolved issues with environment handling for generics (see sketch/trouble-type-list-interface.md)")
