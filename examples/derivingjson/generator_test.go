...
func TestGenerate_Simple(t *testing.T) {
	...
	// A quick fix for the test: remove the first line from both if they are generator comments
	stripGenComment := func(content string) string {
		lines := strings.SplitN(content, "\n", 2)
		if len(lines) > 1 && (strings.HasPrefix(lines[0], "// Code generated by derivingjson") || strings.HasPrefix(lines[0], "// Code generated by ")) {
