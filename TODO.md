...
- [ ] **Add Support for Go Generics**: Update the binding generator to correctly handle (or at least ignore) generic functions to prevent generating non-compiling code.
